...
public class Camera {
    ...
    /**
     * sets the angle of the camera to the given angle.
     * don't use, doesn't update the camera.
    ...
    public void update(GameData gameData) {
        setCamera(gameData.getFocusX(), gameData.getFocusY(), gameData.getFocusAngle());
